...
namespace RealEstateDirectory.MainFormTabs.Room
{
    ...
    public class RoomListViewModel : RealEstateListViewModel<Domain.Entities.Room>
    {
        ...
        protected override IEnumerable<Domain.Entities.Room> UpdateChildFilterData(
            IEnumerable<Domain.Entities.Room> entities)
        {
        ...
        public override AdsAD GetAd(RealEstateViewModel<Domain.Entities.Room> item)
        {
            var estate = item as RoomViewModel;
            var ad = new AdsAD
                {
                    ...
                    RoomsSpecified = true,
                    SaleRooms = estate.RoomCount ?? 0,
                    SaleRoomsSpecified = true,
